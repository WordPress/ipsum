...
<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--40)"><!-- wp:post-title {"level":5,"isLink":true,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"0rem"}},"fontFamily":"manrope"} /-->

<!-- wp:post-date {"datetime":"2026-08-25T12:32:20.987Z","format":"human-diff","isLink":true} /--></div>
<!-- /wp:group -->
